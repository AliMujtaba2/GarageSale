...
export default function CreatePostScreen({ navigation, route }) {
    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: colors.background }}>
            <Appbar.Header style={{ backgroundColor: colors.backgroundSecondary }}>
                <Appbar.BackAction onPress={() => navigation.goBack()} color={colors.text} />
                <Appbar.Content title={isEdit ? "Edit Post" : "Create Post"} titleStyle={{ color: colors.text, fontWeight: "600" }} />
            </Appbar.Header>
            <View style={{ padding: 20 }}>

                {/* Upload Container */}
                <TouchableOpacity style={styles.uploadContainer} onPress={handleImagePick}>
                    <View style={{...styles.dottedBox , borderColor: colors.inputBorder , backgroundColor: colors.inputBackground}}>
                        <ImageSVG color={colors.text} />
                        <Text style={{...styles.uploadText , color: colors.text}}>Upload your Images</Text>
                    </View>
                </TouchableOpacity>
                ...
                {/* Location (fake input) */}
                <TouchableOpacity
                    style={{...styles.fakeInput , borderColor: colors.inputBorder , backgroundColor: colors.inputBackground}}
                    onPress={toggleBottomSheet}
                >
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <LocationPin />
                        <Text
                            style={{...styles.fakeInputText , color: colors.text}}
                        >
                ...
                <BottomSheet isVisible={isVisible}>
                    <View style={{...styles.sheetContainer , backgroundColor: colors.background}}>
                        <Text style={{...styles.sheetTitle , color: colors.text}}>Select Location Option</Text>
                        ...
                        >
                            <Text style={{...styles.sheetOptionText , color: colors.text}}>Use Live Location</Text>
                        </TouchableOpacity>
                        ...
                        >
                            <Text style={{...styles.sheetOptionText , color: colors.text}}>Pick on Map</Text>
                        </TouchableOpacity>

                        <TouchableOpacity
                            style={[styles.sheetOption, { backgroundColor: colors.icon}]}
        ...
        <View style={{...styles.category , backgroundColor: colors.background }}>
                ...
                {/* Date & Time Picker */}
                <TouchableOpacity style={{...styles.fakeInput, backgroundColor: colors.background}} onPress={() => setShowPicker(true)}>
                    <Text style={{...styles.fakeInputText, color: colors.text}}>Tap to Select Date & Time</Text>
                </TouchableOpacity>
                {
                    showPicker && (
